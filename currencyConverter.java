...
public class currencyConverter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 109, 119), 30));
        jPanel1.setBackground(new java.awt.Color(143, 192, 169));

        jLabel1.setFont(new java.awt.Font("Noto Sans", 1, 24));
        jLabel1.setText("Currency Converter");

        firstCountry.setFont(new java.awt.Font("Tahoma", 1, 18));
        firstCountry.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select One...", "USA", "Nigeria",
        ...
        secondCountry.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select One...", "USA", "Nigeria",
                "Brazil", "Canada", "Kenyan", "Indonesia", "India", "Philippine", "Pakistan" }));
        ...
        jButton1.setBackground(new java.awt.Color(238, 218, 167));
        ...
        jButton2.setBackground(new java.awt.Color(238, 218, 167));
        ...
        jButton3.setBackground(new java.awt.Color(238, 218, 167));
